...
static inline void *zbar_decoder_get_userdata (const zbar_decoder_t *dcode)
{
 return(dcode->userdata);
}

static inline void zbar_decoder_set_userdata (zbar_decoder_t *dcode,
                                void *userdata)
{
    dcode->userdata = userdata;
}

static inline zbar_symbol_type_t zbar_decoder_get_type (const zbar_decoder_t *dcode)
{
	return(dcode->type);
}

static inline unsigned int zbar_decoder_get_modifiers (const zbar_decoder_t *dcode)
{
...
static inline zbar_color_t zbar_decoder_get_color (const zbar_decoder_t *dcode)
{
    return(get_color(dcode));
}

static inline const char *zbar_decoder_get_data (const zbar_decoder_t *dcode)
{
    return((char*)dcode->buf);
}

static inline unsigned int zbar_decoder_get_data_length (const zbar_decoder_t *dcode)
{
    return(dcode->buflen);
}

static inline int zbar_decoder_get_direction (const zbar_decoder_t *dcode)
{
    return(dcode->direction);
}

static inline zbar_decoder_handler_t *
