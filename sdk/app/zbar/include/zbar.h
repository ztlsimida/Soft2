...
static inline unsigned zbar_scanner_get_edge (const zbar_scanner_t *scn,
								unsigned offset,
								int prec)
{
...
static inline unsigned zbar_scanner_get_width (const zbar_scanner_t *scn)
{
	return(scn->width);
}
