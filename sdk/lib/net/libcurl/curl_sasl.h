...
struct SASL {
  ...
  _BIT_(resetprefs);           /* For URL auth option parsing. */
  _BIT_(mutual_auth);          /* Mutual authentication enabled (GSSAPI only) */
  _BIT_(force_ir);             /* Protocol always supports initial response */
};
