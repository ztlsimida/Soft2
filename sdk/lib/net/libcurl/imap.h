...
struct imap_conn {
  ...
  _BIT_(ssldone);               /* Is connect() over SSL done? */
  _BIT_(preauth);               /* Is this connection PREAUTH? */
  _BIT_(tls_supported);         /* StartTLS capability supported by server */
  _BIT_(login_disabled);        /* LOGIN command disabled by server */
  _BIT_(ir_supported);          /* Initial response supported by server */
};
