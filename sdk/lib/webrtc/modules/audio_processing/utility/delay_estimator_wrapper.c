...
void *WebRtc_CreateDelayEstimatorFarend(int spectrum_size, int history_size) {
    ...
    if (spectrum_size >= kBandLast) {
        self = (DelayEstimatorFarend *)(
                webrtc_malloc(sizeof(DelayEstimatorFarend)));
    }
    ...
    if (self != NULL) {
        ...
        self->mean_far_spectrum = (SpectrumType *)(
                webrtc_malloc(spectrum_size * sizeof(SpectrumType)));
...
void *WebRtc_CreateDelayEstimator(void *farend_handle, int max_lookahead) {
    ...
    if (farend_handle != NULL) {
        self = (DelayEstimator *)(webrtc_malloc(sizeof(DelayEstimator)));
    }
    ...
    if (self != NULL) {
        ...
        self->mean_near_spectrum = (SpectrumType *)(
                webrtc_malloc(farend->spectrum_size * sizeof(SpectrumType)));
